...
public class Cheese {
	...
	private final static String[] questIt = new String[] {"Quanta ricotta devi fare? ", "Quanta caciotta devi fare? ", 
												  		  "Quanto yogurt devi fare? ",  "Quanto primosale devi fare? ", 
														  "Quanta latteria devi fare? ","Quanta mozzarella devi fare? "};
	private final static String[] questEn = new String[] {"How much ricotta cheese do you have to produce? ", "How much caciotta do you have to produce? ", 
												  		  "How much yogurt do you have to produce? ",  "How much primosale do you have to produce? ", 
														  "How much latteria do you have to produce? ","How much mozzarella do you have to produce? "};
